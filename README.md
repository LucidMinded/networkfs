Это репозиторий выполненного учебного задания по реализации сетевой файловой системы с курса ОС. Весь код выполненного задания находится в одном файле - [entrypoint.c](entrypoint.c)
